...
from .abstract_wc_kernel import Param, SolvedSystem
fr = NewType("fr", float)
...
def calc_Dω(param: Param, equib_point: fr, σ: float,
...
def calc_Dω_range(param: Param, equib_point: fr, σe: float, σi_range: np.ndarray,
...
def fit_ellipse_periodic_orbit(res: SolvedSystem, N: int = 1_000,
...
def calc_AA(param, u, v, σe, σi, τe, τi, ω):
    ...
    Fe = analytic_FT_decexp(σe, ω)
    Fi = analytic_FT_decexp(σi, ω)
    τ = τi/τe
